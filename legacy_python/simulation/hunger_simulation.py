...
from legacy_python.ai import CreatureIntent, HungerAI
from legacy_python.creatures import Creature
from legacy_python.genetics import inherit_traits
from legacy_python.world import FoodField, SimpleMap
