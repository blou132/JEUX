...
class DebugStatsTests(unittest.TestCase):
    def test_population_stats_include_required_fields(self) -> None:
        ...
        self.assertIn("total_poor_zone_drain_events", stats)
        self.assertIn("rich_zone_drain_events_last_tick", stats)
        self.assertIn("total_rich_zone_drain_events", stats)
        self.assertIn("poor_zone_drain_usage_per_alive_tick", stats)
        self.assertIn("rich_zone_drain_usage_per_alive_tick", stats)
        self.assertIn("poor_zone_drain_usage_per_tick_total", stats)
        self.assertIn("rich_zone_drain_usage_per_tick_total", stats)
        self.assertIn("zone_drain_multiplier_avg_last_tick", stats)
        self.assertIn("zone_drain_multiplier_avg_total", stats)
        self.assertIn("environmental_tolerance_poor_users_avg_tick", stats)
        self.assertIn("environmental_tolerance_poor_users_avg_total", stats)
        self.assertIn("environmental_tolerance_poor_usage_bias_tick", stats)
        self.assertIn("environmental_tolerance_poor_usage_bias_total", stats)
        self.assertIn("environmental_tolerance_rich_users_avg_tick", stats)
        self.assertIn("environmental_tolerance_rich_users_avg_total", stats)
        self.assertIn("environmental_tolerance_rich_usage_bias_tick", stats)
        self.assertIn("environmental_tolerance_rich_usage_bias_total", stats)
        ...
        self.assertIn("reproduction_timing_reproduction_users_avg_total", stats)
        self.assertIn("reproduction_timing_reproduction_usage_bias_tick", stats)
        self.assertIn("reproduction_timing_reproduction_usage_bias_total", stats)
        self.assertIn("avg_reproduction_timing_threshold_multiplier_observed_last_tick", stats)
        self.assertIn("avg_reproduction_timing_threshold_multiplier_observed_total", stats)
        self.assertIn("movement_actions_last_tick", stats)
        self.assertIn("total_movement_actions", stats)
        self.assertIn("movement_usage_per_alive_tick", stats)
        ...
        self.assertIn("mobility_efficiency_movement_usage_bias_total", stats)
        ...
        self.assertIn("density_preference_seek_usage_per_alive_tick", stats)
        ...
        self.assertIn("density_preference_avoid_usage_per_alive_tick", stats)
        ...
        self.assertIn("density_preference_avoid_share_total", stats)
