...
class TestGame3DScaffold(unittest.TestCase):
    ...
    def test_readme_mentions_new_3d_direction(self):
        ...
        self.assertIn("support gate tuning", content)
        self.assertIn("support gate playtest protocol", content)
        self.assertIn("before_support_gate.jsonl", content)
        self.assertIn("after_support_gate.jsonl", content)
        self.assertIn("final_decision", content)
        self.assertIn("confidence", content)
        self.assertIn("stability", content)
        self.assertIn("flash success", content)
        self.assertIn("stabilize gate", content)
        self.assertIn("support_gate_success_rate", content)
        self.assertIn("support_gate_available_ratio", content)
        self.assertIn("support_gate_run_attempts", content)
        self.assertIn("support_gate_run_success", content)
        self.assertIn("support_gate_run_success_rate", content)
        self.assertIn("support_gate_run_available_ratio", content)
        self.assertIn("champion_support_attempts_total", content)
        self.assertIn("champion_support_success_total", content)
        self.assertIn("champion_support_unavailable_total", content)
        self.assertIn("champion_support_cooldown_blocked_total", content)
        self.assertIn("champion_support_completed_total", content)
        self.assertIn("champion_support_failed_total", content)
        self.assertIn("champion_support_run_attempts", content)
        self.assertIn("champion_support_run_success", content)
        self.assertIn("champion_support_run_success_rate", content)
        self.assertIn("champion_support_tuning_label", content)
        self.assertIn("champion support tuning: run attempts=", content)
        self.assertIn("run_metrics_latest.json", content)
        self.assertIn("run_metrics_history.jsonl", content)
        self.assertIn("f4", content)
        self.assertIn("gate_support", content)
        self.assertIn("champion_support", content)
        ...
        self.assertIn("champion support accepted", content)
        self.assertIn("gate unavailable", content)
        self.assertIn("champion unavailable", content)
        self.assertIn("no champion available", content)
        self.assertIn("champion_support_available", content)
        self.assertIn("champion_support_candidate_count", content)
        self.assertIn("champion_support_target_label", content)
        self.assertIn("champion_support_progress_label", content)
        self.assertIn("champion_support_debug_label", content)
        self.assertIn("champion_support_visual_actor_id", content)
        self.assertIn("champion_support_visual_state", content)
        self.assertIn("champion_support_visual_label", content)
        self.assertIn("champion_support_locked_actor_id", content)
        self.assertIn("champion_support_lock_timer", content)
        self.assertIn("champion_support_lock_label", content)
        self.assertIn("set_objective_marker", content)
    ...
    def test_debug_overlay_has_poi_status_labels(self):
        ...
        self.assertIn("Support gate visual:", content)
        self.assertIn("Support gate tuning:", content)
        self.assertIn("Champion support tuning:", content)
        self.assertIn("Support gate tuning session:", content)
        self.assertIn("Metrics export:", content)
        self.assertIn("count=", content)
        self.assertIn("history=", content)
        self.assertIn("run attempts=", content)
        ...
        self.assertIn("Champion:", content)
        self.assertIn("Champion support:", content)
        self.assertIn("lock=", content)
        self.assertIn("Champion support lock:", content)
        self.assertIn("Champion support debug:", content)
        self.assertIn("Champion support visual:", content)
        self.assertIn("Champion support visual: state=", content)
        ...
        self.assertIn("run_metrics_export_label", content)
        self.assertIn("run_metrics_export_count", content)
        self.assertIn("run_metrics_last_export_path", content)
        self.assertIn("run_metrics_history_export_path", content)
        self.assertIn("RUN COMPLETED", content)
        self.assertIn("RUN FAILED", content)
    ...
    def test_actor_has_progression_fields(self):
        ...
        self.assertIn("objective_marker_active", content)
        self.assertIn("objective_marker_label", content)
        self.assertIn("objective_marker_flash_timer", content)
        self.assertIn("set_objective_marker", content)
    ...
    def test_game_loop_has_bounty_scheduler_and_metrics(self):
        ...
        self.assertIn("WORLD_OBJECTIVE_ID_RALLY_CHAMPION", content)
        ...
        self.assertIn('"category": "champion_support"', content)
        ...
        self.assertIn("OBJECTIVE_GATE_SUPPORT_REQUIRED_TIME", content)
        self.assertIn("OBJECTIVE_GATE_SUPPORT_REQUIRED_ACTIONS", content)
        self.assertIn("OBJECTIVE_GATE_SUPPORT_FAIL_DEATHS_THRESHOLD", content)
        self.assertIn("OBJECTIVE_GATE_SUPPORT_BAD_STATE_THRESHOLD", content)
        self.assertIn("OBJECTIVE_GATE_SUPPORT_INTERACTION_COOLDOWN", content)
        self.assertIn("OBJECTIVE_CHAMPION_SUPPORT_REQUIRED_TIME", content)
        self.assertIn("OBJECTIVE_CHAMPION_SUPPORT_REQUIRED_ACTIONS", content)
        self.assertIn("OBJECTIVE_CHAMPION_SUPPORT_INTERACTION_COOLDOWN", content)
        self.assertIn("OBJECTIVE_CHAMPION_SUPPORT_FAIL_DEATHS_THRESHOLD", content)
        self.assertIn("OBJECTIVE_CHAMPION_SUPPORT_SUCCESS_FLASH_DURATION", content)
        self.assertIn("OBJECTIVE_CHAMPION_SUPPORT_TARGET_LOCK_TIME", content)
        ...
        self.assertIn("func _build_support_gate_tuning_metrics", content)
        self.assertIn("func _build_champion_support_tuning_metrics", content)
        ...
        self.assertIn('"champion_support_attempts_total": int(snapshot.get("champion_support_attempts_total", 0))', content)
        self.assertIn('"champion_support_success_total": int(snapshot.get("champion_support_success_total", 0))', content)
        self.assertIn('"champion_support_unavailable_total": int(snapshot.get("champion_support_unavailable_total", 0))', content)
        self.assertIn(
            '"champion_support_cooldown_blocked_total": int(snapshot.get("champion_support_cooldown_blocked_total", 0))',
            content
        )
        self.assertIn('"champion_support_completed_total": int(snapshot.get("champion_support_completed_total", 0))', content)
        self.assertIn('"champion_support_failed_total": int(snapshot.get("champion_support_failed_total", 0))', content)
        ...
        self.assertIn("support_gate_run_unavailable_time_baseline", content)
        self.assertIn("champion_support_run_attempts_baseline", content)
        self.assertIn("champion_support_run_success_baseline", content)
        ...
        self.assertIn("func _resolve_champion_support_visual_state", content)
        self.assertIn("func _push_champion_support_objective_visual_state", content)
        self.assertIn("func _update_champion_support_objective_visual_state", content)
        self.assertIn("func _clear_champion_support_objective_markers", content)
        self.assertIn("world_manager.set_support_gate_objective_visual", content)
        self.assertIn("set_objective_marker", content)
        self.assertIn("champion_support_visual_actor_id", content)
        self.assertIn("champion_support_visual_state", content)
        self.assertIn("champion_support_visual_label", content)
        self.assertIn("champion_support_success_flash_timer", content)
        self.assertIn("champion_support_locked_actor_id", content)
        self.assertIn("champion_support_lock_timer", content)
        self.assertIn("func _get_locked_champion_support_actor", content)
        self.assertIn("func _refresh_champion_support_target_lock", content)
        self.assertIn("target_actor_id", content)
        self.assertIn("target_actor", content)
        self.assertIn('visual_state = "target"', content)
        self.assertIn('visual_state = "flash"', content)
        self.assertIn('visual_state = "unavailable"', content)
        self.assertIn('visual_state = "inactive"', content)
        self.assertIn("support_gate_attempts_total", content)
        self.assertIn("support_gate_success_total", content)
        self.assertIn("support_gate_blocked_total", content)
        self.assertIn("support_gate_cooldown_blocked_total", content)
        self.assertIn("support_gate_unavailable_total", content)
        self.assertIn("support_gate_completed_total", content)
        self.assertIn("support_gate_failed_total", content)
        self.assertIn("support_gate_first_success_time", content)
        self.assertIn("support_gate_last_success_time", content)
        self.assertIn("support_gate_available_time_total", content)
        self.assertIn("support_gate_unavailable_time_total", content)
        self.assertIn("champion_support_attempts_total", content)
        self.assertIn("champion_support_success_total", content)
        self.assertIn("champion_support_unavailable_total", content)
        self.assertIn("champion_support_cooldown_blocked_total", content)
        ...
        self.assertIn("KEY_F4", content)
        self.assertIn("func trigger_world_objective_interaction", content)
        self.assertIn("user://run_metrics_latest.json", content)
        self.assertIn("user://run_metrics_history.jsonl", content)
        self.assertIn("export_id", content)
        ...
        self.assertIn("func _update_objective_champion_support", content)
        ...
        self.assertIn('"support_gate_run_attempts"', content)
        self.assertIn('"support_gate_run_success"', content)
        self.assertIn('"support_gate_run_blocked"', content)
        self.assertIn('"support_gate_run_cooldown_blocked"', content)
        self.assertIn('"support_gate_run_unavailable"', content)
        self.assertIn('"support_gate_success_rate"', content)
        self.assertIn('"support_gate_available_ratio"', content)
        self.assertIn('"support_gate_run_success_rate"', content)
        self.assertIn('"support_gate_run_available_ratio"', content)
        self.assertIn('"support_gate_tuning_label"', content)
        self.assertIn('"support_gate_run_tuning_label"', content)
        ...
        self.assertIn("Gate support accepted", content)
        self.assertIn("Champion support accepted", content)
        self.assertIn("Champion support: %d/%d actions, rate=%d%%.", content)
