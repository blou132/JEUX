...
class TestGame3DScaffold(unittest.TestCase):
    ...
    def test_game_loop_has_bounty_scheduler_and_metrics(self):
        ...
        self.assertIn("WORLD_OBJECTIVE_DOMINANCE_TARGET_SECONDS", content)
        self.assertIn("WORLD_OBJECTIVE_FAIL_DEATHS_THRESHOLD", content)
        self.assertIn("WORLD_OBJECTIVE_FAIL_DOMINANCE_SWITCHES", content)
