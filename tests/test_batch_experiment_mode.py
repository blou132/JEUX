...
class BatchExperimentModeTests(unittest.TestCase):
    def test_cli_batch_mode_outputs_summary_per_value(self) -> None:
        ...
        self.assertIn("gregariousness_batch:", output)
        self.assertIn("usage_seek_gregariousness_max:", output)
        self.assertIn("usage_avoid_gregariousness_max:", output)
        self.assertIn("effet_proximite_locale_max:", output)
    ...
    def test_batch_mode_json_export_created_and_coherent(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            gregariousness = comparative.get("gregariousness_comparative")
